...
const router = express.Router(); //Creat the router object witch activate heandler http request 
usersWbService = require("../Services/usersWbAndDBService");//require usersService file
const jwt = require("jsonwebtoken");


// Base url for this controller- http://127.0.0.1:8000/auth
...
router.post("/login", async (req, res) => {
    try {
        ...
        const user = await usersWbService.userLogInAuth(username, email);
